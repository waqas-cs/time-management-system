...
const SignupUser = () => {
    ...
    let userType = signup.userType
    
    const submitHandler = async () => {
        console.log(signup)

       let regrister = await axios.post("http://34.210.129.167/api/users", {
            firstName, lastName, email, password, password_confirmation, userType
